...
{
	public class AuditRequiredPolicyOfT<T> : IAddPolicyOfT<T>, IUpdatePolicyOfT<T> where T : IEntityAudit
	{
		private readonly string _userName;

		public AuditRequiredPolicyOfT(string userName) => _userName = userName;

		public AuditRequiredPolicyOfT(ICoreProvider coreProvider)
		{
