...
{
	public class AppEntityCreatingPolicy<T> : IAddPolicy<T> where T : IAppEntity
	{
		private readonly ICoreProvider _coreProvider;

		public AppEntityCreatingPolicy(ICoreProvider coreProvider) => _coreProvider = coreProvider;
