...
{
	public class TenantEntityCreatingPolicy<T> : IAddPolicy<T> where T : ITenanEntity
	{
		private ICoreProvider _coreProvider;

		TenantEntityCreatingPolicy(ICoreProvider coreProvider) => _coreProvider = coreProvider;
