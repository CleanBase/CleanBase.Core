...
{
	public class DeleteOwnerOnlyPolicyOfT<T> : ModificationPolicyOfT<T>, IDeletePolicyOfT<T> where T : IEntityAudit
	{
		private readonly string _userName;
		private readonly bool _isSuperAdmin;

		public DeleteOwnerOnlyPolicyOfT(string userName, bool isSuperAdmin)
		{
			_userName = userName;
